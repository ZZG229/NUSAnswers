...
public class ModuleHome extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_module_home, menu);
        return true;
    }
    ...
    */
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_module_home, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        private String[] titles = new String[]{"Mid-Term", "Finals", "Cheatsheet"};
